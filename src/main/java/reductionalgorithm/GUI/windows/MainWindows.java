...
public class MainWindows extends AbstractWindow<MainService>{
    ...
    protected void initWindowContent() {
        ...
        this.addComponent("Main.MenuBar",new JMenuBar(),BorderLayout.NORTH,menuBar->{//菜单栏
            ...
            this.addComponent(menuBar,"Main.MenuBar.AlgorithmMenu",new JMenu("算法设置"),menu-> this.addComponent(menu,"Main.AlgorithmMenu.OneAlgorithmMenu",new JMenuItem("更改蚁群算法参数"), menuItem-> menuItem.addActionListener(e -> service.changeAlgorithmParameters(config))));
        });
        this.addComponent("Main.TablePanel",new JTabbedPane(),BorderLayout.CENTER,TabbedPanel->{//算法展示区
            ...
            this.addComponent(TabbedPanel,"Main.OneAlgorithm",new JPanel(new BorderLayout()),panel -> {//查看各个算法运行结果
                ...
                this.addComponent(panel,"Main.OneAlgorithm.ShowPanel",new JPanel(new BorderLayout()),BorderLayout.CENTER,SPanel-> this.addComponent(SPanel, "Main.OneAlgorithm.ShowPanel.Show",(resultPanel_One=new ResultPanel()),BorderLayout.CENTER, ShowPanel -> {
                    ShowPanel.setPreferredSize(SPanel.getSize());
                }));
                this.addComponent(panel,"Main.OneAlgorithm.ButtonPanel",new JPanel(new VerticalLayout(25)),BorderLayout.EAST, BPanel->{
                    this.addComponent(BPanel,"Main.OneAlgorithm.ButtonPanel.GButton",new JButton("G算法"),Button->{
                    ...
                    this.addComponent(BPanel,"Main.OneAlgorithm.ButtonPanel.HGSButton",new JButton("HGS算法"),Button->{
                        Button.addActionListener(e->{
                            if (ret_HGS==null) {
                    ...
                    this.addComponent(BPanel,"Main.OneAlgorithm.ButtonPanel.ACAButton",new JButton("ACA算法"),Button->{
                        Button.addActionListener(e->{
                            if (ret_ACA==null) {
                    ...
                    this.addComponent(BPanel,"Main.OneAlgorithm.ButtonPanel.TSR_ACAButton",new JButton("TSR_ACA算法"),Button->{
                        Button.addActionListener(e->{
                            if (ret_TSR_ACA==null) {
                    ...
                    this.addComponent(BPanel,"Main.OneAlgorithm.ButtonPanel.TSR_GAAButton",new JButton("TSR_GAA算法"),Button->{
                        Button.addActionListener(e->{
                            if (ret_TSR_GAA==null) {
                    ...
                    this.addComponent(BPanel,"Main.OneAlgorithm.ButtonPanel.RTSR_HGSButton",new JButton("RTSR_HGS算法"),Button->{
                        Button.addActionListener(e->{
            ...
            this.addComponent(TabbedPanel,"Main.AllAlgorithm",new JPanel(new BorderLayout()),panel -> {//所有算法运行结果比较
                ...
                this.addComponent(panel,"Main.AllAlgorithm.ShowPanel",new JPanel(new BorderLayout()),BorderLayout.CENTER,SPanel-> this.addComponent(SPanel, "Main.AllAlgorithm.ShowPanel.Show",(resultPanel_All=new ResultPanel()),BorderLayout.CENTER, ShowPanel -> {
                    ShowPanel.setPreferredSize(SPanel.getSize());
                }));
                this.addComponent(panel,"Main.AllAlgorithm.ButtonPanel",new JPanel(new VerticalLayout(25)),BorderLayout.EAST, BPanel->{
                    this.addComponent(BPanel,"Main.AllAlgorithm.ButtonPanel.reductionButton",new JButton("测试用例集约简情况"),button->{
                        button.addActionListener(e -> {
                            if (ret_ALL==null) {
                    ...
                    this.addComponent(BPanel,"Main.AllAlgorithm.ButtonPanel.costButton",new JButton("测试运行代价"),button->{
                        button.addActionListener(e -> {
                            if (ret_ALL==null) {
                                JOptionPane.showMessageDialog(this, "所有算法运行中，请稍后");
                                return;
                    ...
                    this.addComponent(BPanel,"Main.AllAlgorithm.ButtonPanel.error_detectionButton",new JButton("错误检测能力"),button->{
                        button.addActionListener(e -> {
                            if (ret_ALL==null) {
                                JOptionPane.showMessageDialog(this, "所有算法运行中，请稍后");
                                return;
                    ...
                    this.addComponent(BPanel,"Main.AllAlgorithm.ButtonPanel.timeButton",new JButton("算法运行时间"),button->{
                        button.addActionListener(e -> {
                            if (ret_ALL==null) {
                                JOptionPane.showMessageDialog(this, "所有算法运行中，请稍后");
                                return;
